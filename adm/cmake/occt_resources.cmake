...
macro (OCCT_GENERATE_CONTENT_ONLY CurrentResource)
  ...
  if (IS_DIRECTORY "${OCC_ROOT_DIR}/src/${CurrentResource}")
    file (STRINGS "${OCC_ROOT_DIR}/src/${CurrentResource}/FILES" RESOURCE_FILES)
  ...
  if (BUILD_RESOURCES)
    foreach (RESOURCE_FILE ${RESOURCE_FILES})
      ...
      if (IS_RESOURCE)
        ...
        if (toProcessResFile)
          message(STATUS "Info. Generating header file from resource file: ${OCC_ROOT_DIR}/src/${CurrentResource_Directory}/${RESOURCE_FILE}")
          ...
          # read resource file
          file (STRINGS "${OCC_ROOT_DIR}/src/${CurrentResource_Directory}/${RESOURCE_FILE}" RESOURCE_FILE_LINES_LIST)
          ...
          set (HEADER_FILE "${OCC_ROOT_DIR}/src/${CurrentResource_Directory}/${HEADER_FILE_NAME}")
          if (EXISTS "${HEADER_FILE}")
            file (REMOVE "${HEADER_FILE}")
          endif()
          configure_file ("${OCC_ROOT_DIR}/adm/templates/header.in" "${HEADER_FILE}" @ONLY NEWLINE_STYLE LF)
        endif()
      endif()
    endforeach()
  endif()
